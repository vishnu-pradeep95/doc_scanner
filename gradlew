...
#
#   The "Gradle Wrapper" script (gradlew) does not need to run on JVM, so it
#   uses /bin/sh and not #!/usr/bin/env sh; for more details see
...
# temporary directory it contains, and then let sed convert that to a proper
# argument.
eval "set -- $(
